# Disclosure: This script was cleaned and reorganized with assistance from
# ChatGPT (OpenAI) and Claude (Anthropic). The modelling logic, model
# specification, and research workflow remain the author's.
#
# This script implements the 4-stage MNL+OLS joint discrete-continuous
# estimation framework described in the associated paper.
#
# Reference: See Section 3 of the associated paper (Geographical Analysis)
#            and docs/workflow.md for the mathematical formulation.
